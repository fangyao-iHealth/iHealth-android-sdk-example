...
public class HS2SPRO extends FunctionFoldActivity {
    ...
    private static final String TAG = HS2SPRO.class.getSimpleName();
    private Hs2sProControl mHs2sControl;
    ...
    private String mUser = "xqhs012345678900";
    ...
    public void initView() {
        ...
        iHealthDevicesManager.getInstance().addCallbackFilterForDeviceType(mClientCallbackId, iHealthDevicesManager.TYPE_HS2SPRO);
        /* Get hs2s controller */
        mHs2sControl = iHealthDevicesManager.getInstance().getHs2sProControl(mDeviceMac);
        mUser = MD5.encode(mUser);
        ...
        findViewById(R.id.btnSetBleLight).setOnClickListener(this::onViewClicked);
    }
...
//                            + " hardwareVersion:" + hardwareVersion + " modelNumber:" + modelNumber);
            ...
            if (mHs2sControl != null) {
                mHs2sControl.createOrUpdateUserInfo(mUser, (float) 96, 1, 34, 191, 1, 0);
            ...
            if (mHs2sControl != null) {
                mHs2sControl.deleteUserInfo(mUser);
                addLogInfo("deleteUserInfo()");
            }
        } else if (id == R.id.btnSpecifyUserOnline) {
            if (mHs2sControl != null) {
                mHs2sControl.specifyOnlineUsers(mUser, (float) 96, 1, 34, 191, 1, 0);
            ...
            if (mHs2sControl != null) {
                mHs2sControl.stopHeartRateMode();
                addLogInfo("stopHeartRateMode() ");
            }
        } else if (id == R.id.btnSetBleLight) {
            if (mHs2sControl != null) {
