...
public class HS2 extends FunctionFoldActivity {
    ...
    private static final String TAG = "HS2";
    private Hs2Control mHs2Control;
    ...
    public void initView() {
        ...
        iHealthDevicesManager.getInstance().addCallbackFilterForDeviceType(mClientCallbackId, iHealthDevicesManager.TYPE_HS2);
        /* Get hs2 controller */
        mHs2Control = iHealthDevicesManager.getInstance().getHs2Control(mDeviceMac);
    ...
    public void onViewClicked(View view) {
        ...
        if (id == R.id.btnDisconnect) {
            ...
            try {
                mHs2Control.measureOnline(Integer.parseInt(unit), Integer.parseInt(userid));
            ...
            mHs2Control.getOfflineData();
            addLogInfo("getOfflineData()");
        } else if (id == R.id.btnBattery) {
            mHs2Control.getBattery();
            addLogInfo("getBattery()");
        } else if (id == R.id.btnCheckDevice) {//                UpgradeControl.getInstance().queryDeviceFirmwareInfo(mDeviceMac, iHealthDevicesManager.TYPE_HS2);
//                addLogInfo("queryDeviceFirmwareInfo()");
            ...
            UpgradeControl.getInstance().queryDeviceCloudInfo(iHealthDevicesManager.TYPE_HS2, modelNumber, hardwareVersion, firmwareVersion);
            addLogInfo("queryDeviceCloudInfo() -->firmwareVersion:" + firmwareVersion
                    + " hardwareVersion:" + hardwareVersion + " modelNumber:" + modelNumber);
        } else if (id == R.id.btnDownload) {
            UpgradeControl.getInstance().downloadFirmwareFile(iHealthDevicesManager.TYPE_HS2, modelNumber, hardwareVersion, firmwareVersionCloud);
            addLogInfo("downloadFirmwareFile() -->firmwareVersionCloud:" + firmwareVersionCloud);
        } else if (id == R.id.btnUpgrade) {
            UpgradeControl.getInstance().startUpgrade(mDeviceMac, iHealthDevicesManager.TYPE_HS2, modelNumber, hardwareVersion,
            ...
            UpgradeControl.getInstance().stopUpgrade(mDeviceMac, iHealthDevicesManager.TYPE_HS2);
